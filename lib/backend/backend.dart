...
import 'schema/artitst_record.dart';
...
export 'schema/artitst_record.dart';
export 'schema/album_record.dart';

/// Functions to query ArtitstRecords (as a Stream and as a Future).
Stream<List<ArtitstRecord>> queryArtitstRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ArtitstRecord.collection,
...
Future<List<ArtitstRecord>> queryArtitstRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<ArtitstRecord>> queryArtitstRecordPage({
  Query Function(Query)? queryBuilder,
